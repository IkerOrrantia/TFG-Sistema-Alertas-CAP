export const ui = {
    es: {
        ...
        'details.empty': 'Conectado a la red de telemetría RETIME. A la espera de avisos de las autoridades.',
    ...
    en: {
        ...
        'details.empty': 'Connected to RETIME telemetry network. Awaiting alerts from authorities.',
    ...
    eu: {
        ...
        'details.empty': 'RETIME telemetria sarera konektatuta. Agintarien abisuen zain.',
    ...
    pt: {
        ...
        'details.empty': 'Ligado à rede de telemetria RETIME. A aguardar avisos das autoridades.',
